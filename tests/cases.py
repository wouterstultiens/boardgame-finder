...
TEST_CASES: List[PromptTestCase] = [
    ...
    PromptTestCase(
        ...
        bgg=[{"id": "299571", "name": "Bandida", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        ...
        bgg=[{"id": "", "name": "", "lang": "", "exact_match": False}] # Not on BGG
    ),
    PromptTestCase(
        ...
        expected=[{"name": "Ticket to Ride: Europa 1912", "lang": "en"}],
        bgg=[{"id": "53383", "name": "Ticket to Ride: Europa 1912", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        ...
        bgg=[{"id": "276894", "name": "Ticket to Ride: London", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        ...
        expected=[{"name": "Ticket to Ride: India + Switzerland", "lang": "en"}],
        bgg=[{"id": "106645", "name": "Ticket to Ride Map Collection 2: India & Switzerland", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        ...
        bgg=[{"id": "147938", "name": "Ticket to Ride Map Collection 4: Nederland ", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        ...
        bgg=[{"id": "1406", "name": "Monopoly", "lang": "en", "exact_match": False}] # Almost all Dutch editions not on BGG
    ),
    PromptTestCase(
    ...
    PromptTestCase(
        ...
        bgg=[{"id": "13972", "name": "Party & Co: Original", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        name="nl_billy_bever",
        ...
        expected=[{"name": "Bert Bever", "lang": "nl"}],
        bgg=[{"id": "50458", "name": "Billy Biber", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
        name="nl_camel_up",
        ...
        expected=[{"name": "Camel Up", "lang": "nl"}],
        bgg=[{"id": "153938", "name": "Camel Up", "lang": "nl", "exact_match": True}]
    ),
    PromptTestCase(
        ...
        expected=[{"name": "Carcassonne Reiseditie", "lang": "nl"}],
        bgg=[{"id": "822", "name": "Carcassonne", "lang": "en", "exact_match": False}] # Dutch edition not on BGG
    ),
    PromptTestCase(
        name="nl_kalaha",
        ...
        expected=[{"name": "Kalaha", "lang": "nl"}], # It is Dutch text on the cover, but hard to read
        bgg=[{"id": "", "name": "", "lang": "", "exact_match": False}] # No Kalaha on BGG
    ),
    PromptTestCase(
        ...
        expected=[{"name": "Monopoly: Arnhem", "lang": "nl"}],
        bgg=[{"id": "1406", "name": "Monopoly", "lang": "en", "exact_match": False}] # Almost all Dutch editions not on BGG
    ),
    PromptTestCase(
        ...
        expected=[{"name": "Monopoly: Wereldeditie", "lang": "nl"}],
        bgg=[{"id": "295051", "name": "Monopoly World", "lang": "en", "exact_match": True}]
    ),
    PromptTestCase(
